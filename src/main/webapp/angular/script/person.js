...
// relative path needed for angular app
// http://bartwullems.blogspot.se/2014/07/angularjs-using-relative-paths.html
...
app.factory('personService', function ($resource, rootUrl) {
    app.factory.$inject = ["$resource", "rootUrl"];
